...
void main() {
  group('ResumeSummaryService', () {
    ...
    test('computeRange uses previous marker end in same chapter', () {
      ...
      expect(range.shouldUpdateResumeMarker, isTrue);
    });
    ...
    test('computeRange supports selections before the saved marker', () {
      final marker = ResumeMarker(
        bookId: 1,
        chapterIndex: 2,
        selectedText: 'later',
      ...
      expect(range, isNotNull);
      expect(range!.startOffset, 4);
      expect(range.endOffset, 12);
      expect(range.sourceText, '456789AB');
      expect(range.shouldUpdateResumeMarker, isFalse);
    });

    test('computeRange preserves forward overlap behavior', () {
      final marker = ResumeMarker(
        bookId: 1,
        chapterIndex: 2,
        selectedText: 'old',
